...
let firstWorkout = Workout(distance: 900, time: 100, identifier: 1)
print(firstWorkout)
//:  Make the `Workout` class above conform to the `Equatable` protocol. Two `Workout` objects should be considered equal if they have the same identifier. Create another instance of `Workout`, giving it an identifier of 2, and print a boolean expression that evaluates to whether or not it is equal to the first `Workout` instance you created.


let secondWorkout = Workout(distance: 1000, time: 110, identifier: 2)
...
let thirdWorkout = Workout(distance: 800, time: 70, identifier: 3)
let fourthWorkout = Workout(distance: 500, time: 140, identifier: 4)
let fifthWorkout = Workout(distance: 200, time: 170, identifier: 5)
