...
var areaRectangle=Rectangle(width: 10, height: 10)
...
var personHeight=Height(heightInInches: 68)
print("heightIninches is \(personHeight.heightInInches)")
personHeight=Height(heightInCentimeters: 175)
print("heightInCentimeter \(personHeight.heightInInches)")
