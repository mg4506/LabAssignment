...
struct User {
    ...
    var email: String
    var age: Int
//    static var currUser = User(userName:"",email:"",age:0)
    //or
    static var currUser: User{
        //get
        //{
            User(userName:"hello",email:"hello@gmail.com",age:20)
        //}
        
    }
}
let loggedInuser=User.currUser
print("\(loggedInuser.userName),\(loggedInuser.email),\(loggedInuser.age)")
//var detail=User(userName: "Abc", email: "xyz@gmail", age: 20)
//print(detail)
/*:
