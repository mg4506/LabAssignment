...
var favouriteBook=Book(title: "Book1", author: "Abc", page: 10,price: 100.0)
print(favouriteBook.title)
print(favouriteBook.author)
print(favouriteBook.page)
...
var laptop1=Laptop(yearPurchased: 0)
var laptop2=Laptop(yearPurchased: 0)
 ...
 */
struct Height{
    var heightInhes:Double
    var heightCentimeter:Double
    init(heightInhes: Double) {

        self.heightInhes = heightInhes
        heightCentimeter=self.heightInhes/2.54
    }

    init(heightInCentimeters: Double){
        self.heightCentimeter=heightInCentimeters
        self.heightInhes=self.heightCentimeter*2.54
    }
}
let height = 65
var cal1=Height(heightInhes: 65)

var cal2=Height(heightInCentimeters: 65)
print(cal2.heightInhes)
...
var myHeight=Height(heightInhes: 65)
myHeight=Height(heightInCentimeters: 65)
print(myHeight.heightInhes)
print(myHeight.heightCentimeter)
