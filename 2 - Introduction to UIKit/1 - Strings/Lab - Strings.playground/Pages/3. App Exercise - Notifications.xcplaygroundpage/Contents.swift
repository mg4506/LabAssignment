...
let newBest = 15125
print("Congratulations,\(fullName)! You beat your previous daily high score of "+String(newBest)+" steps by walking" + "String(newBest)"+" steps yesterday!")
